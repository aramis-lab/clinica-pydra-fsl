...
class SwapDimSpec(ShellSpec):
    ...
    new_x: str = field(
        metadata={"help_string": "new x-axis", "mandatory": True, "argstr": "", "allowed_values": ALLOWED_AXES}
    )

    new_y: str = field(
        metadata={"help_string": "new y-axis", "mandatory": True, "argstr": "", "allowed_values": ALLOWED_AXES}
    )

    new_z: str = field(
        metadata={"help_string": "new z-axis", "mandatory": True, "argstr": "", "allowed_values": ALLOWED_AXES}
    )

    output_image: str = field(
        metadata={"help_string": "output image", "argstr": "", "output_file_template": "{input_image}_swapdim"}
    )
