...
class MergeSpec(ShellSpec):
    ...
    output_image: str = field(metadata={"help_string": "output image", "argstr": "", "output_file_template": "merged"})
    ...
    repetition_time: float = field(
        metadata={"help_string": "specify TR value in seconds (default is 1.0)", "argstr": ""}
    )
